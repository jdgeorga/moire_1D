...
# Input parameters
structures_dir = "path/to/your/structures"
structure_files = ["structure1.extxyz", "structure2.extxyz"]
structure_file_format = "extxyz"
output_struc_name = "my_moire_output.xyz"
twist_min_search = 0.1

twist_max_search = 5.0
desired_strain = 0.01
max_permissible_strain = 0.05
is_1D_dir_1 = False
is_1D_dir_2 = True
Rmax_max_search = 50
max_iter_twist_search = 4
