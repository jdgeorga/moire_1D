...
def lammps_relax(input_file, output_file):
    ...
    atoms.positions[atoms.arrays["atom_types"] >= 3,1] += 0.1
    ...
    dyn.run(fmax=4e-4)  # Run until the maximum force is below 1e-3 eV/Å
...
if __name__ == "__main__":
    ...
    xyz_file_path = "MoS2_WSe2_2D_big.xyz"
    out_file = 'MoS2_WSe2_2D_big_lammps'
